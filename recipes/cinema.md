...
## [stack] tech
Next.js (App Router) + Tailwind CSS. GSAP + Lenis. React Three Fiber only if the beam lands. next/font, next/image. Showtimes as typed local data (JSON/MDX) — static-first, revalidate daily. Vercel. No UI kits.
