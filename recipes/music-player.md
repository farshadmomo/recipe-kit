...
## [seo] search
MUST use /seo scaled to reality: this is an app — correct meta, OG share card in the hardware art direction, and a crawlable landing view. Skip audit tooling; there's nothing to audit until there are public pages.
