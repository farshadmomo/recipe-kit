...
## [stack] tech
Next.js (App Router) + Tailwind CSS. GSAP + Lenis. React Three Fiber + drei for the dome. next/font, next/image. Shows and sky data as typed local data. Static-first. Vercel. No UI kits.
