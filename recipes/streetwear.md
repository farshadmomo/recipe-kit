...
## [testing] checks
Cart math, stock holds, and size availability get the checks first. Verify motion by driving the page at both motion preferences.
